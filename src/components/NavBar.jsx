...
export default function NavBar({ data }) {
  ...
  const { navWrapperRef } = data;

  return (
    <nav className="nav" ref={navWrapperRef} >
      <span className="logo">
      ...
      <div className="hamburger-menu">
        <input 
        onClick={(e) => {
          if (e.target.checked) nav.current.classList.add("nav-reveal");
          else nav.current.classList.remove("nav-reveal");
        }} 
        type="checkbox" />
        <span></span>
        <span></span>
